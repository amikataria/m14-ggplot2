...
names.of.col <- colnames(diamonds)
names.of.col
num.of.rows <- count(diamonds)
num.of.rows
...
ggplot(diamonds.sample) + geom_point(aes(x = carat, y = price, color = clarity))
...
ggplot(diamonds.sample) + geom_point(aes(x = carat, y = price), color = "blue")


# Draw a scatter plot for `diamonds.sample` of `price` by `carat`, where each
# point has an aesthetic _shape_ based on the diamond's `cut`.
ggplot(diamonds.sample) + geom_point(aes(x = carat, y = cut, shape = cut))
